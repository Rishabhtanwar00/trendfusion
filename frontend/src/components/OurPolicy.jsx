...
const OurPolicy = () => {
	return (
		<div className='flex flex-col sm:flex-row justify-around items-center gap-12 sm:gap-2 text-center py-20 px-[20px] sm:px-[40px] text-xs sm:text-sm md:text-base text-gray-700'>
			<div className=''>
